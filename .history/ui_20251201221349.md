...
|  - Topics/Channels    |  - Topic intro / banner           |  - Summary and Timeline        |
|  - Agents (P/O)       |  - Message stream (P/O/User)      |  - Agents lineup and "raise hand" indicatiors   |
|  -                    |                                   |  -    |
|  -                    |                                   |  - Files/Tasks/artefactories     |
|                       |                                   |  -         |
+-----------------------+-----------------------------------+--------------------+
