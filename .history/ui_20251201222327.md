...
3. **Main Chat Column:** Topic intro/banner and message stream for user, primary agent, and observers. Inline state events deferred; thread previews not shown. Thread toggle is a simple “show/hide observer visibility” control. Down is bottom composer.
