...
Use modern app style, responsive, adding motion place holders when waiting, SSE to respond faster, markdown live rendering to better display messages. Chat interaction should be as stylish and light feeling like OpenAI ChatGPT.