...
B. **Toggle Agent:** Promote one agent as Primary agent in the middle of a session. At this stage only one primate agent is allowed. The old primate is demoted to observe agent.
