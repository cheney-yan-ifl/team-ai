...
Main Chat:
  ...
  - Thread visibility toggle (for observers/passive viewers)

Right Detail Panel:
  - Session state snapshot (status, step, health, blockers)
  - Active agents lineup with activity/raise-hand indicators
  - Artifacts & tools (files, tasks, actions, tool runs)
  - Timeline of recent events

Bottom Composer:
  - Rich text editor, @mentions, uploads
  - (No additional status line until needed)
```
