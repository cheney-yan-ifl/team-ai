...
A. **Session State Snapshot:** A summary of this topic, updated live. There should be a global organizer agent running behind the scene. (not visible to the chats -- only used for organizing chats.)
